                    ...
                    ZStack {
                        if isZoomingFromAlbum {
                            ...
                            Circle()
                                ...
                                .frame(width: cardCircleWidth)
                                .shadow(color: .white.opacity(0.08), radius: 3, x: 1.5, y: 1.5)
                                .shadow(color: .black, radius: 3, x: -1.5, y: -1.5)
                        }
                    }
                    .frame(width: cardWidth, height: cardHeight)
                    .overlay(RoundedRectangle(cornerRadius: isZoomingFromAlbum ? 20 : 24).stroke(Color.white.opacity(0.1), lineWidth: 0.8))
